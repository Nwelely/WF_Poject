...
<?php include('partials/Navigation-Index.php'); ?>
    ...
    // Capture the role from the URL, default to 'user' if not set
    ...
    if (isset($_POST['signup'])) {
        ...
        $role = isset($_POST['role']) ? sanitizeInput($_POST['role']) : $role; // Use the passed role or the default role
    
        $role = empty($role) ? 'user' : $role;
